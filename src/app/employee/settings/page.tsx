...
export default function EmployeeSettingsPage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    setSaving(true)
    try {
      await employeeApi.patch('/employee/profile', { name })
      await fetchMe()
        ...
        <form onSubmit={handleSave} className="space-y-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="border-[#07472e]/20 bg-[#07472e]/5 text-[#07472e] focus-visible:ring-[#07472e]"
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              value={user?.email ?? ''}
              disabled
              className="border-[#07472e]/20 bg-[#fbfff3] text-[#647a6b] cursor-not-allowed"
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              disabled
              className="border-[#07472e]/20 bg-[#fbfff3] text-[#647a6b] cursor-not-allowed capitalize"
            />
          </div>
          <Button
            type="submit"
